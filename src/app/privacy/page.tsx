...
export const metadata: Metadata = {
  title: 'Privacy Policy — GuffGaff',
  description: 'How GuffGaff collects, uses, and protects your data.',
};
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <Section title="1. Information We Collect">
          <p>When you use GuffGaff, we may collect:</p>
        ...
        <Section title="6. Children's Privacy">
          <p>
            GuffGaff is not intended for users under the age of 16. We do not
        ...
        <Section title="7. Third-Party Services">
          ...
          <ul className="list-disc list-inside space-y-1 mt-2">
            ...
            <li><strong>Google / Facebook OAuth</strong> — Optional social login.</li>
          </ul>
        </Section>
